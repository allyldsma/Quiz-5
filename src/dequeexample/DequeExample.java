...
public class DequeExample {
    ...
    public static void main(String[] args) {
        ...
        DNode<String> node1 = new DNode<>(null, "Ritchel", null);
        DNode<String> node2 = new DNode<>(null, "Clare", null);
        DNode<String> node3 = new DNode<>(null, "Diane", null);
        DNode<String> node4 = new DNode<>(null, "Nina", null);
        DNode<String> node5 = new DNode<>(null, "Jessa", null);
